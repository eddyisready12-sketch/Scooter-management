...
export const demoData: AppData = {
  ...
  complianceFamilies: [],
  complianceFamilyRisks: [],
  complianceFamilyWarnings: [],
  complianceFamilyDocuments: [],
  complianceFamilyRequirements: [],
  complianceFamilyTestPlans: [],
  complianceProductTests: [],
  complianceFamilyRevisions: [],
  complianceProductLinks: [],
  dealers,
  products: [],
  suppliers: [],
  importers: [],
