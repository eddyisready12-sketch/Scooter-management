...
import { asOptionalTrimmedString, buildScooterBarcodeDataUrl, createEmptyPackagingLayer, isStickerPackagingLayer, normalizePackagingLayers, openOuterBoxLabelPreview, previewProductZebraLabel, printOuterBoxDymoLabel, printProductDymoLabel, printProductZebraLabel, printScooterDymoLabel, productImporterLabelValue, zebraProductLabelLayouts } from './lib/labels';
...
export function App() {
  ...
  async function saveComplianceFamilyBundle(payload: {
    ...
    await replaceComplianceFamilyRisks(nextFamily.id, nextRisks);
    await replaceComplianceFamilyWarnings(nextFamily.id, nextWarnings);
    await replaceComplianceFamilyDocuments(nextFamily.id, nextDocuments);
    await replaceComplianceFamilyRequirements(nextFamily.id, nextRequirements);
